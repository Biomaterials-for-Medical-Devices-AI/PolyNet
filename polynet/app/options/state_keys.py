...
class DescriptorCalculationStateKeys(StrEnum):
    ...
    SelectAllPMXRepeatUnit = "SelectAllPMXRepeatUnit"
    SelectAllPMXSideChainDescriptors = "SelectAllPMXSideChainDescriptors"
    SelectAllPMXBackboneDescriptors = "SelectAllPMXBackboneDescriptors"
