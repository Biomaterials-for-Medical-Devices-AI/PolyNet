...
==================================
Allowable values and defaults for atom and bond features used by the GNN featuriser.
"""
...
atom_properties[AtomFeature.GetIsAromatic] = None  # boolean property, no options needed
atom_properties[AtomFeature.GetMass] = None  # continuous property, no options needed
...
bond_features[BondFeature.GetIsAromatic] = None  # boolean property, no options needed
bond_features[BondFeature.GetIsConjugated] = None  # boolean property, no options needed
...
bond_features[BondFeature.IsInRing] = None  # boolean property, no options needed
